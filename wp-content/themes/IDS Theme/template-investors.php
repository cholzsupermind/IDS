...
$investors = array(
    ...
    array('','bordeaux-capital (need  link)'),
    array('','btg-capital (need  link)'),
    array('','chris-kantrowitz (need  link)'),
    ...
    array('','highline-capital (need  link)'),
    array('','integrated (need  link)'),
    ...
    array('','peak-asset-management (need  link)'),
    array('pif.vc','PIF'),
    ...
    array('','robert-mcquade (need  link)'),
